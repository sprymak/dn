...
const RCNF_FILE_ADDED      = $0001;
const RCNF_FILE_DELETED    = $0002;
const RCNF_DIR_ADDED       = $0003;
const RCNF_DIR_DELETED     = $0004;
const RCNF_MOVED_IN        = $0005;
const RCNF_MOVED_OUT       = $0006;
const RCNF_CHANGED         = $0007;
const RCNF_OLDNAME         = $0008;
const RCNF_NEWNAME         = $0009;
const RCNF_DEVICE_ATTACHED = $000A;
const RCNF_DEVICE_DETACHED = $000B;
...
begin
  repeat
    ...
    if Dos32ResetChangeNotify(@Data, SizeOf(Data), LogCount, NotifyHandle) = 0 then
...
begin
  ...
  Initialized := (DosLoadModule(nil, 0, 'DOSCALLS', DOSCALLS) = 0)
    ...
    and (DosQueryProcAddr(DOSCALLS, 442, nil, @Dos32CloseChangeNotify) = 0);
