...
type
  ...
  TDNApplication = object(TApplication)
    ...
    {procedure OutOfMemory; virtual;}
    procedure RetrieveDesktop(const FileName: String; LS: PStream; LoadColors: Boolean);
...
procedure TDNApplication.ViewFile(AltExt, NoExtFile: Boolean; FileName: String);
begin
