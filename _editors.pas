...
type
  ...
  TXFileEditor = object(TView)
    ...
    constructor Init(var Bounds: TRect; AHScrollBar, AVScrollBar: PScrollBar; var FileName: String);
...
function TXFileEditor.KeyMapConvertStr(S: LongString; toAscii: Boolean): LongString;
begin
