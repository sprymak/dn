...
begin
  ...
  if (CharCode <> 0) and (ShiftState and {Left_}{JO} Alt_Pressed = 0) then
    begin
      if (CharCode = 9) and (ShiftState and Shift_Pressed <> 0) then
        ...
        if (CharCode <> $E0) or ((CharCode = $E0) and (KeyCode=$48) and  (ScanCode=$23) and (ShiftState and AltCtrl_Pressed = 0) ) then
          begin
